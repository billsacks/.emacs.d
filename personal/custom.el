...
(custom-set-faces
 ...
 '(org-agenda-dimmed-todo-face ((t (:slant italic))))
 ...
 '(org-level-1 ((t (:inherit outline-1 :extend nil :family "CharterSpacedAbove"))))
 '(org-level-2 ((t (:inherit outline-2 :extend nil :family "CharterSpacedAbove"))))
 '(org-level-3 ((t (:inherit outline-3 :extend nil :family "CharterSpacedAbove"))))
 '(org-level-4 ((t (:inherit outline-4 :extend nil :family "CharterSpacedAbove"))))
 '(org-level-5 ((t (:inherit outline-5 :extend nil :family "CharterSpacedAbove"))))
