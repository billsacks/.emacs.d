...
(custom-set-faces
 ...
 '(sml/col-number ((t (:inherit sml/global :family "Hack"))))
 '(sml/line-number ((t (:inherit sml/modes :weight bold :family "Hack"))))
 '(sml/not-modified ((t (:inherit sml/global :height 1 :family "Hack"))))
 '(sml/position-percentage ((t (:inherit sml/prefix :weight normal :family "Hack"))))
