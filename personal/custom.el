...
(custom-set-faces
 ...
 '(ediff-current-diff-A ((t (:extend t :background "#ffeede"))))
 '(ediff-current-diff-Ancestor ((t (:extend t :background "#ffeede"))))
 '(ediff-current-diff-B ((t (:extend t :background "#ffeede"))))
 '(ediff-current-diff-C ((t (:extend t :background "#ffeede"))))
 ...
 '(ediff-fine-diff-A ((t (:background "#ffe240"))))
 '(ediff-fine-diff-Ancestor ((t (:background "#ffe240"))))
 '(ediff-fine-diff-B ((t (:background "#ffe240"))))
 '(ediff-fine-diff-C ((t (:background "#ffe240"))))
 ...
 '(show-paren-match ((t (:background "#b2d7ff"))))
