...
(custom-set-faces
 ...
 '(ediff-even-diff-Ancestor ((t (:extend t :background "gray90"))))
 '(ediff-even-diff-B ((t (:extend t :background "gray90"))))
 '(ediff-even-diff-C ((t (:extend t :background "gray90"))))
 '(ediff-fine-diff-C ((t (:background "#f0f055"))))
 '(ediff-odd-diff-A ((t (:extend t :background "gray82"))))
 '(ediff-odd-diff-Ancestor ((t (:extend t :background "gray82"))))
 '(ediff-odd-diff-B ((t (:extend t :background "gray82"))))
 '(ediff-odd-diff-C ((t (:extend t :background "gray82"))))
