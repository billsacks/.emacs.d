...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit outline-1 :extend nil :family "CharterSpaced"))))
 '(org-level-2 ((t (:inherit outline-2 :extend nil :family "CharterSpaced"))))
 '(org-level-3 ((t (:inherit outline-3 :extend nil :family "CharterSpaced"))))
 '(org-level-4 ((t (:inherit outline-4 :extend nil :family "CharterSpaced"))))
 '(org-level-5 ((t (:inherit outline-5 :extend nil :family "CharterSpaced"))))
 '(org-level-6 ((t (:inherit outline-6 :extend nil :family "CharterSpaced"))))
 '(org-level-7 ((t (:inherit outline-7 :extend nil :family "CharterSpaced"))))
 '(org-level-8 ((t (:inherit outline-8 :extend nil :family "CharterSpaced"))))
 ...
 '(outline-1 ((t (:foreground "blue4"))))
 '(outline-2 ((t (:foreground "firebrick4"))))
 '(outline-3 ((t (:foreground "purple4"))))
 '(outline-4 ((t (:foreground "VioletRed4"))))
 '(outline-5 ((t (:foreground "RoyalBlue4"))))
 '(outline-6 ((t (:foreground "sienna4"))))
 '(outline-7 ((t (:foreground "dark slate blue"))))
 '(outline-8 ((t (:foreground "#006000"))))
