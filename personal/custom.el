...
(custom-set-faces
 ...
 '(flycheck-fringe-info ((t (:inherit success :foreground "gray75"))))
 '(flycheck-info ((t (:underline (:color "gray75" :style wave)))))
