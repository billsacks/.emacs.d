...
(custom-set-faces
 ...
 '(flycheck-error ((t (:underline "#ffb8dd"))))
 '(flycheck-fringe-error ((t (:foreground "#ffb8dd"))))
 '(flycheck-fringe-info ((t (:foreground "gray82"))))
 '(flycheck-fringe-warning ((t (:foreground "#ffcc80"))))
 '(flycheck-info ((t (:underline "gray82"))))
 '(flycheck-warning ((t (:underline "#ffcc80"))))
