...
(custom-set-faces
 ...
 '(org-ellipsis ((t (:foreground "RosyBrown"))))
 ...
 '(outline-5 ((t (:foreground "sienna4"))))
 '(outline-6 ((t (:foreground "RoyalBlue4"))))
 '(outline-7 ((t (:foreground "VioletRed4"))))
